...
def run_batch():
    ...
    try:
        ...
        for ext_path in extensions:
            ...
            if leak:
                print(Back.YELLOW + f"Unexpected leak for {ext_id} during passive test" + Back.RESET)
            else:
                print(Fore.GREEN + f"No leak for {ext_id}" + Fore.RESET)
